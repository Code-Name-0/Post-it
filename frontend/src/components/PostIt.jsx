...
const POSTIT_COLORS = [
  { bg: '#FFF176', header: '#F9A825' }, // jaune
  { bg: '#FFCCBC', header: '#E64A19' }, // orange
  { bg: '#C8E6C9', header: '#388E3C' }, // vert
  { bg: '#BBDEFB', header: '#1565C0' }, // bleu
  { bg: '#E1BEE7', header: '#7B1FA2' }, // violet
  { bg: '#F8BBD0', header: '#C2185B' }, // rose
  { bg: '#B2EBF2', header: '#00838F' }, // cyan
];
...
export default function PostIt({ postit, currentUser, onMove, onDelete, onEdit }) {
  ...
  return (
    ...
    >
      ...
      {/* En-tête : avatar + auteur + bouton supprimer */}
      ...
      {/* Pied : date + badge modifié + icône édition */}
